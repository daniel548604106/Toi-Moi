...
const Stories = () => {
  ...
  return (
    <div className="flex w-full mt-2 space-x-1   overflow-hidden ">
      <div className="relative  flex-shrink-0   w-1/3 sm:w-1/4 xl:w-1/5  rounded-md transition duration-75 cursor-pointer hover:opacity-80 ">
        <img
          className="h-30 sm:h-56 w-full relative object-cover rounded-3xl rounded-b-none"
